...
void PI_update(void) {
    ...
    /// TODO: calculate error signal and write to "error" variable
		...
		// using 2:1 ratio between encoder count and output rpm
    ...
    /// TODO: Calculate proportional portion, add integral and write to "output" variable
		...
		uint16_t proportional = (error) * Kp;
    int16_t output = proportional + (error_integral); // maybe divide error integral by 3200?
